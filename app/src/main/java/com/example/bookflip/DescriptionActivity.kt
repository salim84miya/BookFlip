...
class DescriptionActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val descriptionOfBooks = mutableListOf<String>("Coming Soon with description.",getString(R.string.atomic_habits_description),getString(R.string.rich_dad_poor_dad_description),getString(R.string.psychology_of_money_description),getString(R.string.how_to_win_friends_description))
